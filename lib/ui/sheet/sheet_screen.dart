...
import '../_core/widgets/stack_dialog.dart';
...
import '../sheet_module_magic/sheet_module_magic.dart';
import '../sheet_notes/sheet_notes.dart';
import '../sheet_shopping/dialogs/upinsert_item_dialog.dart';
...
import 'components/roll_tip_widget.dart';
import 'components/roll_widget.dart';
...
class _SheetScreenState extends State<SheetScreen> {
  ...
  void _rollInitiative({bool isVisible = true}) {
    ActionTemplate actionTemplate = context
        .read<SheetViewModel>()
        .actionRepo
        .getAllActions()
        .firstWhere((e) => e.id == ImportantActions.resistirReflexos);
    ...
    SheetInteract.rollAction(
      ...
      groupId: groupId,
      rollType: RollType.difficult,
      rollInitiativeVisible: isVisible,
    );
  }
